...
// TODO Insert未看懂
// Insert 参数 就是要插入的数据 如 insert(&User{1,2,3},&User{4,23,2})
func(s *Session)Insert(values ...interface{})(int64,error){
	...
	sql,vars := s.clause.Builde(clause.INSERT,clause.VALUES)
 ...
 */
 ...
 func(s *Session)Find(values ...interface{})error{
		...
		sql ,vars := s.clause.Builde(clause.SELECT,clause.WHERE,clause.ORDERBY,clause.LIMIT)
